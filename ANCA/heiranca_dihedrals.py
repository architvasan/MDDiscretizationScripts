...
if __name__ == "__main__":
    ...
    pdb_file = args.pdbfile#"../../../NMNAT2-allH.pdb"
    traj_file = args.traj#"../../../NMNAT2.1us.dcd"
    selections = [args.sel]#[f"protein and resid 117 to 193 and backbone"] ## one off on both ends for dihedral calcs
